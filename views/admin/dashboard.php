                ...
                <?php foreach ($transactions as $transaction) : ?>
                    <tr>
                        ...
                        <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                            <a href="/admin/users/<?php echo escape($transaction['user_id']); ?>" class="p-2 bg-amber-50 text-xs text-amber-900 hover:bg-amber-500 hover:text-white transition rounded">
