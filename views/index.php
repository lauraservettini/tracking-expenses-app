                ...
                <?php foreach ($transactions as $transaction) : ?>
                    <tr>
                        ...
                        <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                            <a href="/transaction/<?php echo escape($transaction['id']); ?>/receipt" class="p-2 bg-indigo-50 text-xs text-indigo-600 hover:bg-indigo-500 hover:text-white transition rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
